    ...
    public interface ILogboekService
    {
        ...
        Task ContactRequestAction(KnownContactAction knownContactAction, Guid internetaakId, Guid objectId);
    }
        ...
        : ILogboekService
    {
        ...
        public async Task ContactRequestAction(KnownContactAction knownContactAction,Guid internetaakId, Guid objectId)
        {
            var logboekData = await GetOrCreateLogboek(internetaakId);
          
                var logboekAction = MapLogboekAction(logboekData, objectId, knownContactAction.Title,
        ...
        public async Task<ObjectResult<LogboekData>> GetOrCreateLogboek(Guid internetaakId)
        {
        ...
        public ObjectPatchModel<LogboekData> MapLogboekAction(ObjectResult<LogboekData> logboek, Guid objectId,
