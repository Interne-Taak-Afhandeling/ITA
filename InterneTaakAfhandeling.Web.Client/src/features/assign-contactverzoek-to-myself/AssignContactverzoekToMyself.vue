  ...
  <utrecht-alert-dialog ref="toewijzenAlertRef">
    <form method="dialog" @submit.prevent="toewijzen">
      ...
      <utrecht-button-group>
        <utrecht-button appearance="primary-action-button" type="submit">Toewijzen aan mezelf</utrecht-button>
        <utrecht-button appearance="secondary-action-button" type="button" @click="close">Annuleren</utrecht-button>
      </utrecht-button-group>
    </form>
  </utrecht-alert-dialog>
  <utrecht-button type="button" appearance="primary-action-button" @click="show">Toewijzen aan mezelf</utrecht-button>
</template>
